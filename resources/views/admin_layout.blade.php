...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link rel="stylesheet" href="admintheme/css/morris.css" type="text/css" />
    <!-- calendar -->
    <link rel="stylesheet" href="admintheme/css/monthly.css">
    <!-- //calendar -->
    <!-- //font-awesome icons -->
    <script src="admintheme/js/jquery2.0.3.min.js"></script>
    <script src="admintheme/js/raphael-min.js"></script>
    <script src="admintheme/js/morris.js"></script>
</head>
...
<body>
    ...
    <!-- calendar -->
    <script type="text/javascript" src="admintheme/js/monthly.js"></script>
